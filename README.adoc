= Spring Cloud Services Connector image:https://build.spring.io/plugins/servlet/wittified/build-status/CLOUD-SCPC["Build Status", link="https://build.spring.io/browse/CLOUD-SCPC"]
